...
/**
 * This is the item provider adapter for a {@link spd.policyconstraint.TargetGroupSizeConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TargetGroupSizeConstraintItemProvider extends StateBasedContraintItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PolicyconstraintPackage.Literals.TARGET_GROUP_SIZE_CONSTRAINT__MIN_SIZE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PolicyconstraintPackage.Literals.TARGET_GROUP_SIZE_CONSTRAINT__MAX_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
